...
TEXT_WIN = "WIN";
TEXT_HOLD = "HOLD";
TEXT_HELP_WILD = "THIS SYMBOL CAN REPLACE ANY OTHER SYMBOL TO MAKE UP A COMBO";
...
function CMenu() {
    ...
    this._init = function() {
        ...
        z = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT - 60, q, TEXT_PLAY, FONT_GAME, "#FFEBCD", 32, s_oStage);
...
function CInterface(a, e, f) {
    ...
    this._init = function(H, P, S) {
        ...
        x = new CTextButton(328 + C.width / 2, CANVAS_HEIGHT - C.height / 2, C, TEXT_INFO, FONT_GAME, "#FFEBCD", 30, s_oStage);
        x.addEventListener(ON_MOUSE_UP, this._onInfo, this);
        C = s_oSpriteLibrary.getSprite("but_lines_bg");
        F = new CTextButton(494 + C.width / 2, CANVAS_HEIGHT - C.height / 2, C, TEXT_LINES, FONT_GAME, "#FFEBCD", 30, s_oStage);
        F.addEventListener(ON_MOUSE_UP,
        this._onAddLine, this);
        B = new CTLText(s_oStage, 494, CANVAS_HEIGHT - 86, C.width, 26, 26, "center", "#FFEBCD", FONT_GAME, 1, 0, 0, NUM_PAYLINES, !0, !0, !1, !1);
        B.setShadow("#000", 2, 2, 2);
        C = s_oSpriteLibrary.getSprite("coin_but");
        c = new CTextButton(680 + C.width / 2, CANVAS_HEIGHT - C.height / 2, C, TEXT_COIN, FONT_GAME, "#FFEBCD", 30, s_oStage);
        c.addEventListener(ON_MOUSE_UP, this._onBet, this);
        y = new CTLText(s_oStage, 680, CANVAS_HEIGHT - 86, C.width, 26, 26, "center", "#FFEBCD", FONT_GAME, 1, 0, 0, H.toFixed(2), !0, !0, !1, !1);
        y.setShadow("#000", 2, 2,
        2);
        C = s_oSpriteLibrary.getSprite("but_maxbet_bg");
        n = new CTextButton(866 + C.width / 2, CANVAS_HEIGHT - C.height / 2, C, TEXT_MAX_BET, FONT_GAME, "#FFEBCD", 30, s_oStage);
        n.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);
        L = new CTLText(s_oStage, 866, CANVAS_HEIGHT - 86, C.width, 26, 26, "center", "#FFEBCD", FONT_GAME, 1, 0, 0, TEXT_BET + ": " + P.toFixed(2), !0, !0, !1, !1);
    ...
    this._createPayouts = function() {
        ...
        for (var k = [{
            ...
            if (0 !== h) {
                ...
                e[r] = [];
                for (var z = 0; z < h; z++) {
                    var m = new createjs.Text("X" + (5 - z), "25px " + FONT_GAME, "#FFEBCD");
                    m.textAlign = "center";
                    m.x = k[l].x;
                    m.y = v;
